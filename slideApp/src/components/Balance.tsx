...
function Balance() {
    ...
    const { loading, error, data } = useQuery<WalletBalanceResponse, any>(GET_USER_WALLET_BALANCE, {
    ...
    return (
        <Typography variant="h3" style={{ marginTop: 16 }}>${data.userWalletBalance.uiAmountString} USDC</Typography>
    );
}
