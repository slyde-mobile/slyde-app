...
const AddFunds: React.FC = () => {
    ...
    const fullAddress = user?.snsAccount
        ? user?.snsAccount?.account.toBase58()
        : ''; // Replace with actual full address
    ...
    return (
        ...
        >
            <Typography variant="h5" mb={4}>
                Use either address below to fund your slyde account with USDC.{' '}
                <br />
                Please send <strong>only</strong> native USDC on Solana to this
                account.
            </Typography>
